...
export const kbArticles: KbArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Notices, IDs, claims: MSN — Medicare Summary Notice (Original Medicare; first-level appeal generally 120 days). MBI — Medicare Beneficiary Identifier (the number on the red-white-blue card). SOB — Summary of Benefits. EOC — Evidence of Coverage (the plan contract). ANOC — Annual Notice of Change (fall notice of next-year changes). MAC — Medicare Administrative Contractor (processes Original Medicare claims). CMS — Centers for Medicare & Medicaid Services.',
